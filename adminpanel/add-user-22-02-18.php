             ...
             <form class="cmxform form-horizontal " name="commentForm" id="commentForm" method="post" action="" autocomplete="off" enctype="multipart/form-data">
               ...
               <div class="form-group ">
                 ...
                 <div class="col-lg-3">
                  ...
                  <?php $custQry = $mfp->mf_query("Select id,reseller_company from customers where 1 = 1 $compnyqry group by reseller_company asc");
						if($mfp->mf_affected_rows()>0) 
						{   
                  ...
                  <div class="col-lg-3">
                    ...
                    <select name="to_customer[]" id="multiselect_to" class="form-control" size="8" multiple="multiple">
                    	<?php if($id>0 && !empty($custArr)){ ?>
                         <?php $custQry = $mfp->mf_query("Select id,reseller_company from customers where id IN (".$customer_ids.") group by reseller_company asc");
						if($mfp->mf_affected_rows()>0) 
						{   
							while($custRow = $mfp->mf_fetch_array($custQry))
							{
                ...
                <div class="form-group ">
                  ...
                  <div class="col-lg-6">
                    <input class="form-control" id="first_name" name="first_name" value="<?=$first_name;?>" minlength="2" type="text" required />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="last_name" class="control-label col-lg-3">Last Name*</label>
                  <div class="col-lg-6">
                    <input class="form-control" id="last_name" name="last_name" value="<?=$last_name;?>" minlength="2" type="text" required />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="email" class="control-label col-lg-3">Email*</label>
                  <div class="col-lg-6">
                    <input class="form-control" id="email" name="email" value="<?=$email;?>" minlength="2" type="email" required />
                  </div>
                </div>
                <div class="form-group ">
                  <label for="password" class="control-label col-lg-3">Password*</label>
                  <div class="col-lg-6">
                    <input class="form-control" id="password" name="password" value="<?=$password;?>" minlength="2" type="password" <? if(!$id>0) { ?> required <?PHP } ?> />
                    <? if($id>0) { ?>
